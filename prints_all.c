...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/12 18:23:00 by myprosku          #+#    #+#             */
/*   Updated: 2018/03/12 18:23:00 by myprosku         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		while (i < temp->len)
		{
			if (i != temp->len - 1)
				ft_printf("\e[1m%s\e[0m %S ",
					name_top(top, temp->a_way[i]), L"➠");
			else
				ft_printf("\e[1m%s\e[0m", name_top(top, temp->a_way[i]));
			i++;
		}
		ft_printf("\n");
		temp = temp->next;
